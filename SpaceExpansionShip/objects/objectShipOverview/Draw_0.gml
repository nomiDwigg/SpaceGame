...
draw_text(objectShipOverview.x + 260, objectShipOverview.y + 215, "Gold:              " + string(global.goldResource));
draw_set_color(c_dkgray);
draw_text(objectShipOverview.x + 260, objectShipOverview.y + 235, "Iron:             " + string(global.ironResource));
draw_set_color(c_ltgray);
draw_text(objectShipOverview.x + 260, objectShipOverview.y + 255, "Titanium:      " + string(global.titaniumResource));
draw_set_color(c_teal);
draw_text(objectShipOverview.x + 260, objectShipOverview.y + 275, "Silicon:      " + string(global.siliconResource));
draw_set_color(c_black);
draw_text(objectShipOverview.x + 260, objectShipOverview.y + 295, "Carbon:      " + string(global.carbonResource));
