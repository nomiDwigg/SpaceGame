...
if (global.weaponsLevel < 2)
{
	...
	draw_sprite_stretched(spriteResources, 0, (objectUpgradeButton4.x + 50 + weaponsWidth), (objectUpgradeButton4.y - 50), 50, 50);
	draw_sprite_stretched(spriteResources, 2, (objectUpgradeButton4.x + 50 + weaponsWidth), (objectUpgradeButton4.y - 20), 50, 50);
