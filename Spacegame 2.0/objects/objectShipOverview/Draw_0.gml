...
draw_sprite(spriteheat, 0, (objectShipOverview.x + 780), (objectShipOverview.y + 75));
draw_sprite(spritecold, 0, (objectShipOverview.x + 780), (objectShipOverview.y + 175));
draw_sprite(spriteradiation, 0, (objectShipOverview.x + 780), (objectShipOverview.y + 275));
draw_sprite(spriteweapons, 0, (objectShipOverview.x + 780), (objectShipOverview.y + 375));
draw_sprite(spritesustainability, 0, (objectShipOverview.x + 780), (objectShipOverview.y + 475));

draw_text((objectShipOverview.x + 890), (objectShipOverview.y + 90), string(global.heatResistanceLevel));
draw_text((objectShipOverview.x + 890), (objectShipOverview.y + 190), string(global.coldResistanceLevel));
draw_text((objectShipOverview.x + 890), (objectShipOverview.y + 290), string(global.radiationResistanceLevel));
draw_text((objectShipOverview.x + 890), (objectShipOverview.y + 390), string(global.weaponsLevel));
draw_text((objectShipOverview.x + 890), (objectShipOverview.y + 490), string(global.sustainabilityLevel));
